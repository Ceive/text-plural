...
class SimpleCase extends \PHPUnit_Framework_TestCase{
	...
	public function testPlural(){
		...
		$this->assertEquals('25 арбуза', $p->render(25));
	...
	public function testTemplate(){
		...
		$this->assertEquals('было загружено 9 файлов', $p->render(7));
		$this->assertEquals('было загружено 10 файлов', $p->render(8));
		$this->assertEquals('было загружено 11 файлов', $p->render(9));
		$this->assertEquals('было загружено 12 файлов', $p->render(10));
		$this->assertEquals('было загружено 17 файлов', $p->render(12));
		$this->assertEquals('было загружено 20 файлов', $p->render(15));
		$this->assertEquals('был загружен 21 файл', $p->render(20));
		$this->assertEquals('были загружены 22 файла', $p->render(21));
		$this->assertEquals('были загружены 23 файла', $p->render(23));
		$this->assertEquals('были загружены 24 файла', $p->render(25));
